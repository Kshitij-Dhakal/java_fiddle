...
public class TemplateMatchingFiddle {
    ...
    public static boolean matchesTemplate(
            String template, String generatedText) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(matchesTemplate("Sign up for ${{amt}}/mo", "Sign up for $3.99/mo (50% off)")); // false
    }
}
